...
public class Database {
	...
	/**
	 * Application qui lance la base de données .
	 */
	public Database() {
	}
	...
	public boolean creatDatabase() {
		...
		try {
			...
			stmt.execute(createTable);
			createTable = "CREATE TABLE  IF NOT EXISTS CarreGroupe(gnom varchar(50), nom varchar(50), PRIMARY KEY(gnom,nom), "
					+ "FOREIGN KEY (gnom) REFERENCES Groupe(gnom) ON DELETE CASCADE, "
					+ "FOREIGN KEY (nom) REFERENCES Carre(nom) ON DELETE CASCADE)";
			stmt.execute(createTable);
			createTable = "CREATE TABLE  IF NOT EXISTS CercleGroupe(gnom varchar(50), nom varchar(50), PRIMARY KEY(gnom,nom),"
					+ " FOREIGN KEY (gnom) REFERENCES Groupe(gnom) ON DELETE CASCADE,"
					+ " FOREIGN KEY (nom) REFERENCES Cercle(nom) ON DELETE CASCADE)";
			stmt.execute(createTable);
			createTable = "CREATE TABLE  IF NOT EXISTS RectangleGroupe(gnom varchar(50), nom varchar(50), PRIMARY KEY(gnom,nom),"
					+ " FOREIGN KEY (gnom) REFERENCES Groupe(gnom) ON DELETE CASCADE,"
					+ " FOREIGN KEY (nom) REFERENCES Rectangle(nom) ON DELETE CASCADE)";
			stmt.execute(createTable);
			createTable = "CREATE TABLE  IF NOT EXISTS TriangleGroupe(gnom varchar(50), nom varchar(50), PRIMARY KEY(gnom,nom),"
					+ " FOREIGN KEY (gnom) REFERENCES Groupe(gnom) ON DELETE CASCADE,"
					+ " FOREIGN KEY (nom) REFERENCES Triangle(nom) ON DELETE CASCADE)";
			stmt.execute(createTable);
			createTable = "CREATE TABLE  IF NOT EXISTS GroupeGroupe(gnom varchar(50), nom varchar(50), PRIMARY KEY(gnom,nom)"
					+ ", FOREIGN KEY (gnom) REFERENCES Groupe(gnom) ON DELETE CASCADE, "
					+ "FOREIGN KEY (nom) REFERENCES Groupe(gnom) ON DELETE CASCADE)";
			stmt.execute(createTable);
			/////////////////////////////////////////////////////////////////////////////

			createTable = "CREATE TABLE  IF NOT EXISTS CarreDessin(dnom varchar(50), nom varchar(50), PRIMARY KEY(dnom,nom),"
					+ " FOREIGN KEY (dnom) REFERENCES Dessin(dnom) ON DELETE CASCADE, "
					+ "FOREIGN KEY (nom) REFERENCES Carre(nom) ON DELETE CASCADE)";
			stmt.execute(createTable);
			createTable = "CREATE TABLE  IF NOT EXISTS CercleDessin(dnom varchar(50), nom varchar(50), PRIMARY KEY(dnom,nom), "
					+ "FOREIGN KEY (dnom) REFERENCES Dessin(dnom) ON DELETE CASCADE, "
					+ "FOREIGN KEY (nom) REFERENCES Cercle(nom) ON DELETE CASCADE)";
			stmt.execute(createTable);
			createTable = "CREATE TABLE  IF NOT EXISTS RectangleDessin(dnom varchar(50), nom varchar(50), PRIMARY KEY(dnom,nom), "
			...
			stmt.execute(createTable);
			createTable = "CREATE TABLE  IF NOT EXISTS TriangleDessin(dnom varchar(50), nom varchar(50), PRIMARY KEY(dnom,nom), "
					+ "FOREIGN KEY (dnom) REFERENCES Dessin(dnom) ON DELETE CASCADE,"
					+ " FOREIGN KEY (nom) REFERENCES Triangle(nom) ON DELETE CASCADE)";
			stmt.execute(createTable);
			createTable = "CREATE TABLE  IF NOT EXISTS  GroupeDessin(dnom varchar(50), nom varchar(50), PRIMARY KEY(dnom,nom),"
					+ " FOREIGN KEY (dnom) REFERENCES Dessin(dnom) ON DELETE CASCADE, "
					+ "FOREIGN KEY (nom) REFERENCES Groupe(gnom) ON DELETE CASCADE)";
			stmt.execute(createTable);
			return true;
